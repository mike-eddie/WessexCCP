...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { student_id: @attendance.student_id, teaching_session_id: @attendance.teaching_session_id }
    end
  ...
  test "should update attendance" do
    put :update, id: @attendance, attendance: { student_id: @attendance.student_id, teaching_session_id: @attendance.teaching_session_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
